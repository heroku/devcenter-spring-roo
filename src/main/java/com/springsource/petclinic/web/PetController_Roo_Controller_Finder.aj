...
privileged aspect PetController_Roo_Controller_Finder {
    ...
    public java.lang.String PetController.findPetsByNameAndWeightForm(Model uiModel) {
        return "pets/findPetsByNameAndWeight";
    }
    
    @RequestMapping(params = "find=ByNameAndWeight", method = RequestMethod.GET)
    public java.lang.String PetController.findPetsByNameAndWeight(@RequestParam("name") java.lang.String name, @RequestParam("weight") java.lang.Float weight, Model uiModel) {
    ...
    public java.lang.String PetController.findPetsByOwnerForm(Model uiModel) {
    ...
    public java.lang.String PetController.findPetsByOwner(@RequestParam("owner") Owner owner, Model uiModel) {
    ...
    public java.lang.String PetController.findPetsBySendRemindersAndWeightLessThanForm(Model uiModel) {
    ...
    public java.lang.String PetController.findPetsBySendRemindersAndWeightLessThan(@RequestParam(value = "sendReminders", required = false) boolean sendReminders, @RequestParam("weight") java.lang.Float weight, Model uiModel) {
    ...
    public java.lang.String PetController.findPetsByTypeAndNameLikeForm(Model uiModel) {
    ...
    public java.lang.String PetController.findPetsByTypeAndNameLike(@RequestParam("type") PetType type, @RequestParam("name") java.lang.String name, Model uiModel) {
